...
public class NodoAVL {
    ...
    //Variable que se utiliza como bandera para poder balancear el árbol cuando sea necesario.
    ...
    */
    public void graficar(String path) {
        ...
        /*
        Definiremos la construccion del grafico en un try catch para evitar problemas añl momento
        de generar la imagen, el cual estara ubicada dentro de las carpetas de nuestro proyecto
        */
        try
        {
            //El nombre de la imagen del grafico
